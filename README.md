...
Bu repository, FinTechBankX DDD/EDA dönüşümünde **svc-ctr-openapi-catalog** servis yetkinliğinin kaynak kodunu, kontratlarını ve operasyonel guardrail'lerini içerir.
...
| Service ID | svc-ctr-openapi-catalog |
| Bounded Context | openapi_catalog |
| Wave | 4 |
...
## Kapsam
### In Scope
- openapi_catalog bağlamına ait uygulama kodu, testler ve otomasyon.
