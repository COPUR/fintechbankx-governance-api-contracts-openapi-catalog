...
- **Tribe:** Governance & Architecture Tribe
- **Squad:** API Contracts Squad
- **Repo Kümesi:** `governance-contracts`
- **Bounded Context:** `governance`
- **Ana Capability:** OpenAPI catalog governance
- **Dönüşüm Wave:** 4
...
- `OpenAPI catalog governance` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
